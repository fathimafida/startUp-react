...
const BrandSection = () => {
  return (
    <div className="flex flex-col items-center justify-center py-3 ">
      <h1 className="font-semibold text-sm">PARTNERS</h1>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-5 lg:grid-cols-5 gap-4 items-center mb-4">
        <img className="w-[100px]" src={Google} />
        <img className="w-[100px]" src={Microsoft} />

        <img className="w-[100px]" src={AirBnb} />
        <img className="w-[100px]" src={FaceBook} />
        <img className="w-[100px]" src={Spotify} />
      </div>
